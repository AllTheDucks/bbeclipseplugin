...
/**
 * Test rendering hook 'tag.learningSystemPage.start'
 * 
 * @author mmccullough
 * @since 9.2
 */
public class LearningSystemPageHookTest implements RenderingHook
{

  @Override
  public String getContent()
  {
    JspResourceIncludeUtil.getThreadInstance().addCssFile( "/test/learningSystemPageTest.css" );
    return "<div>tag.learningSystemPage.start</div>";
  }
